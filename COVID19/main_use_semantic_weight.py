...
def main():
    ...
    url1 ='Dataset/94Encode_COVID_Brazil_Symptom_based_Train.csv'
    url2 ='Dataset/94Encode_COVID_Brazil_Symptom_based_Test.csv'
    ...
    concept_weight = pd.read_csv('COVID19_Semantic_weighted.csv',names=colnames, header=None)
...
# # ==========================Semantic Decision Tree=====================================
    ...
    precision_1,recall_1,accuracy_rate_1 = test(id3treeOW.getRoot(), train_ID3OW, target,'yes')
    print()
       
    print('Train Semantic Decision Tree accuracy : ', accuracy_rate_1)
    
    recision_2,recall_2,accuracy_rate_2 = test(id3treeOW.getRoot(), test_ID3OW, target,'yes')
    print()
